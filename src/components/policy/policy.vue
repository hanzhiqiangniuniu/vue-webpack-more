<template>
  <div>
    <v-nav></v-nav>
    <div class="policy">
      <h2>Career China:  Privacy Policy</h2>
      <p>
 ...
 <br><br>
      ...
      <p>
        ...
        Candidate: An individual who uses the Services, including by browsing company profiles, scheduling a speaking with a recruiter or a career advisor, applying for a job posted on the Platform, and/or reading or otherwise engaging with company research and other content on the Platform or through email.
 ...
 <br><br>
      ...
      <h4>Third-Party Analytics and Targeted Advertising</h4>
      <p>
 ...
 <br><br>
        If you want to learn more about the Personal Information that Career China has about you, or you would like to update or change that information, please contact us.
        If you no longer want to receive marketing communications from Career China, please follow the “unsubscribe” instructions that are included at the bottom of each message. Please note that if you unsubscribe from our marketing communications, you will still receive administrative messages.
             </p>
