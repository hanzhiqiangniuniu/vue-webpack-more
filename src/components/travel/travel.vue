<template>
  <div class="travel">
    ...
    <ul class="tab">
      ...
      <li>
        <a href="javascript:;" class="active" title="travel in China">Travel</a>
      </li>
      <li>
  ...
  export default{
    ...
    mounted(){
      ...
      aMore.onclick=function () {
        page++;
        _this.$http.get('http://'+interfaceStr+'/careerchina/cc/blog/pageBlogs/getByCategoryId.action?rowCount=10&page='+page+'&categoryId=3').then(function (response) {
      ...
      this.$http.get('http://'+interfaceStr+'/cc/blog/pageBlogs/getByCategoryId.action?rowCount=10&page='+page+'&categoryId=3').then(function (response) {
