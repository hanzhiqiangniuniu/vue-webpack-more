<template>
  <div class="workBox">
    ...
    <ul class="tab">
      ...
      <li>
        <a href="javascript:;" class="active" title="work in China">Work</a>
      </li>
      <li>
  ...
  export default{
    ...
    mounted(){
      ...
      aMore.onclick=function () {
        page++;
        _this.$http.get('http://'+interfaceStr+'/careerchina/cc/blog/pageBlogs/getByCategoryId.action?rowCount=10&page='+page+'&categoryId=5').then(function (response) {
