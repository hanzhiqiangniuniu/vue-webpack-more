<template>
  <div class="live">
    ...
    <ul class="tab">
      ...
      <li>
        <a href="javascript:;" class="active" title="live in China">Live</a>
      </li>
      <li>
...
//4）点击焦点手动切换
      ...
      aMore.onclick=function () {
        page++;
        _this.$http.get('http://'+interfaceStr+'/careerchina/cc/blog/pageBlogs/getByCategoryId.action?rowCount=10&page='+page+'&categoryId=4').then(function (response) {
      ...
      this.$http.get('http://'+interfaceStr+'/cc/blog/pageBlogs/getByCategoryId.action?rowCount=10&page='+page+'&categoryId=4').then(function (response) {
